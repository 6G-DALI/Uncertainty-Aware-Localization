...
The ULA subset of the nomadic dataset from https://ieee-dataport.org/open-access/ultra-dense-indoor-mamimo-csi-dataset is used as data. Download and place the `nomadic_dataset` directory under `data/` (resulting in `data/nomadic_dataset/ULA_lab_LoS`).
